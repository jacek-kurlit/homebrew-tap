class Pik < Formula
    ...
    on_linux do
      on_arm do
        url "https://github.com/jacek-kurlit/pik/releases/download/#{version}/pik-#{version}-aarch64-unknown-linux-gnu.tar.gz"
        sha256 "ca5686e844b59222c79a084e7e91d1236c92b16e78e6b89c611690cb3edf65a7"
      end
      on_intel do
        url "https://github.com/jacek-kurlit/pik/releases/download/#{version}/pik-#{version}-x86_64-unknown-linux-gnu.tar.gz"

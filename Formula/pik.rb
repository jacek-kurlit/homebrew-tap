class Pik < Formula
    ...
    on_macos do
      on_arm do
        url "https://github.com/jacek-kurlit/pik/releases/download/1.0.1/pik-1.0.1-aarch64-apple-darwin.tar.gz"
        sha256 "02cbe6eac32f0ea17d28334246e40da8edc6c24b932e56245a4912590c1e6382"
      end
      on_intel do
        url "https://github.com/jacek-kurlit/pik/releases/download/1.0.1/pik-1.0.1-x86_64-apple-darwin.tar.gz"
    ...
    on_linux do
      on_arm do
        url "https://github.com/jacek-kurlit/pik/releases/download/1.0.1/pik-1.0.1-aarch64-unknown-linux-gnu.tar.gz"
        sha256 "3aea0f9d636e41300c3614d77294e4d69b238f8c6389714061245ba0e6ea3d8e"
      end
      on_intel do
        url "https://github.com/jacek-kurlit/pik/releases/download/1.0.1/pik-1.0.1-x86_64-unknown-linux-gnu.tar.gz"
